...
| **Clinical Ink** | 300-450 | 75-120 | ~75% | eCOA/eSource study builds, data management, support tickets, and analytics are heavily automatable. Study configuration that currently takes 10 days → AI can do in hours. Data queries, support triage, and reporting are LLM-native tasks. Engineering team shrinks with AI coding tools. |
| **Catalyst Clinical Research** | 1,000+ | 250-350 | ~70% | Medical writing (CSRs, IBs) → AI-generated. Data management → AI cleaning/reconciliation. Biostatistics → AI-assisted analysis. Site monitoring → risk-based AI monitoring. Clinical operations → AI-optimized. The CRO model is 60% knowledge work that AI handles well. Wet lab/site visits are the human floor. |
...
|-------------------|--------------------|-----------------|
| **FDA 21 CFR Part 11** | Azurity, Bend, Clinical Ink, Catalyst, Lexitas | Electronic signatures, audit trails — AI can operate within these but needs validation |
...
| **ICH-GCP** | Catalyst, Lexitas, Vector, Clinical Ink | Clinical trials require qualified investigators, monitors — but monitoring can be risk-based/AI-driven |
...
| **Q3 2026** | InformedDNA, Clinical Ink | Tier 2 — significant knowledge work automation |
| **Q4 2026** | Catalyst, Lexitas | Tier 2-3 — CRO automation (medical writing, data mgmt) |
| **Q1 2027** | Vector, Applied StemCell | Tier 3 — physical + digital hybrid automation |
| **Q2 2027** | Azurity, Bend Bioscience | Tier 4 — manufacturing AI + robotics (longest lead time) |
...
|-----------|-------------|--------|
| **LLM Gateway** | Centralized Claude/GPT API management, cost optimization, prompt library | All 11 companies |
| **Document Intelligence** | OCR, NLP, document understanding pipeline | COPILOT, InformedDNA, Univo, Catalyst, Lexitas |
...
| **Predictive Analytics** | Shared ML model training/deployment infrastructure | All 11 companies |
| **Regulatory AI** | FDA, ICH, HIPAA compliance monitoring | Azurity, Bend, Catalyst, Clinical Ink, Lexitas, Univo |
...
### 5. Clinical Ink — "The AI Trial Technology Platform"

**Current State:** 300-450 FTEs building and supporting eCOA/eSource/DCT solutions
**Target State:** 75-120 FTEs with AI-driven study builds, automated support, and AI-powered product features

**What Gets Replaced:**

| Function | Current FTEs | AI Replacement | Remaining Humans |
|----------|-------------|----------------|-----------------|
| Study Configuration | 40-60 | AI auto-build from protocol → study configuration in hours vs. 10 days | 5-10 complex study builders |
| Data Management | 30-40 | AI query generation, anomaly detection, auto-cleaning | 5-8 data managers |
| Customer Support | 30-40 | AI chatbot + auto-ticket resolution (40%+ deflection) | 10-15 tier 2/3 support |
| Engineering | 60-80 | AI-assisted development (50% productivity gain) | 30-40 engineers |
| QA/Testing | 20-30 | AI test generation + automated testing | 5-8 QA leads |
| Analytics/Product | 15-20 | AI-powered TrialLens + auto-reporting | 5-8 product/analytics |
| Sales/BD | 15-20 | RFP automation + deal scoring + competitive intel | 8-10 senior sales |
| Admin/Leadership | 20-30 | AI-assisted | 10-15 |

**Investment:** $4-6M over 24 months
**Annual Savings:** $15-20M
**Study Build Time:** 10 days → hours

---

### 6. Catalyst Clinical Research — "The AI-Powered CRO"

**Current State:** 1,000+ FTEs across global clinical operations
**Target State:** 250-350 FTEs with AI handling medical writing, data management, biostats, and monitoring intelligence

**What Gets Replaced:**

| Function | Current FTEs | AI Replacement | Remaining Humans |
|----------|-------------|----------------|-----------------|
| Medical Writing | 50-80 | AI-generated CSRs, IBs, protocols, regulatory docs | 10-15 senior writers for review |
| Data Management | 80-120 | AI data cleaning, query generation, reconciliation | 15-25 data managers |
| Biostatistics | 40-60 | AI-assisted SAP, TLF generation, analysis | 10-15 senior biostatisticians |
| Clinical Monitoring | 150-200 | Risk-based AI monitoring, auto-visit reports, signal detection | 50-70 monitors (site visits still required) |
| Project Management | 80-100 | AI scheduling, risk prediction, resource optimization | 25-35 senior PMs |
| Safety/PV | 30-50 | AI case processing, signal detection, aggregate reporting | 10-15 safety scientists |
| Regulatory | 30-40 | AI submission automation, regulatory intelligence | 8-12 regulatory specialists |
| Commercial/BD | 30-40 | RFP automation, deal scoring, competitive intel | 15-20 senior BD |
| Admin/Leadership | 50-80 | AI-assisted | 25-35 |

**Investment:** $8-12M over 36 months
**Annual Savings:** $30-50M
**Revenue per Employee:** $150-200K → $400-500K

---

### 7. Lexitas — "The AI Ophthalmology CRO"
...
### 8. Vector Clinical Trials — "The AI-Powered Site Network"
...
### 9. Applied StemCell — "The AI Genome Intelligence Platform"
...
### 10. Azurity Pharmaceuticals — "The AI Pharma Platform"
...
### 11. Bend Bioscience — "The AI-Native CDMO"
...
| Clinical Ink | ~375 | ~100 | 73% | $15-20M | $4-6M | 4-6 mo |
| Catalyst | ~1,000 | ~300 | 70% | $30-50M | $8-12M | 4-6 mo |
...
| **TOTALS** | **~3,035** | **~1,140** | **~62%** | **$107-159M** | **$47-59M** | **~6 mo avg** |

**Portfolio-wide: ~1,900 FTEs replaced, $107-159M annual savings, 6-month average payback.**
...
| **Weeks 9-10** | Phase 0-1: Intelligence + decomposition | InformedDNA, Clinical Ink |
| **Weeks 11-12** | Phase 2-4: Architecture + financials | InformedDNA, Clinical Ink |
| **Weeks 13-15** | Phase 0-4: Full deep dive | Catalyst, Lexitas |
| **Weeks 16-18** | Phase 0-4: Full deep dive | Vector, Applied StemCell |
| **Weeks 19-22** | Phase 0-4: Full deep dive | Azurity, Bend Bioscience |
| **Weeks 23-24** | Phase 5: Portfolio-wide implementation roadmap | All companies |
| **Ongoing** | Phase 6: Cross-portfolio AI platform build | Shared infrastructure |

**Total Timeline: 24 weeks (6 months) to complete all deep dives, with Tier 1 implementations starting in parallel by Week 8.**
...
- **Post-transformation annual savings:** $107-159M
- **At 12-15x EBITDA multiple (healthcare services):** $1.3-2.4B in incremental enterprise value
- **Investment required:** $47-59M
- **Enterprise value creation per dollar invested:** $22-51 return
